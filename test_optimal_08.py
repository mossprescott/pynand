...
from project_07 import translate_line
...
def test_code_size_pong():
    ...
    translate_dir(translate, translate_line, "examples/Pong")
    translate_dir(translate, translate_line, "nand2tetris/tools/OS")  # HACK not committed
...
def test_cycles_to_init():
    ...
    translate_dir(translate, translate_line, "examples/Draw")
    translate_dir(translate, translate_line, "nand2tetris/tools/OS")  # HACK not committed
