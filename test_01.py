...
def test_and16():
    assert eval(And16, a=0b0000_0000_0000_0000, b=0b0000_0000_0000_0000).out == 0b0000_0000_0000_0000
    assert eval(And16, a=0b0000_0000_0000_0000, b=0b1111_1111_1111_1111).out == 0b0000_0000_0000_0000
    assert eval(And16, a=0b1111_1111_1111_1111, b=0b1111_1111_1111_1111).out == 0b1111_1111_1111_1111
    assert eval(And16, a=0b1010_1010_1010_1010, b=0b0101_0101_0101_0101).out == 0b0000_0000_0000_0000
    assert eval(And16, a=0b0011_1100_1100_0011, b=0b0000_1111_1111_0000).out == 0b0000_1100_1100_0000
    assert eval(And16, a=0b0001_0010_0011_0100, b=0b1001_1000_0111_0110).out == 0b0001_0000_0011_0100

def test_mux16():
    assert eval(Mux16, a=0b0000_0000_0000_0000, b=0b0000_0000_0000_0000, sel=0).out == 0b0000_0000_0000_0000
    assert eval(Mux16, a=0b0000_0000_0000_0000, b=0b0000_0000_0000_0000, sel=1).out == 0b0000_0000_0000_0000
    assert eval(Mux16, a=0b0000_0000_0000_0000, b=0b0001_0010_0011_0100, sel=0).out == 0b0000_0000_0000_0000
    assert eval(Mux16, a=0b0000_0000_0000_0000, b=0b0001_0010_0011_0100, sel=1).out == 0b0001_0010_0011_0100
    assert eval(Mux16, a=0b1001_1000_0111_0110, b=0b0000_0000_0000_0000, sel=0).out == 0b1001_1000_0111_0110
    assert eval(Mux16, a=0b1001_1000_0111_0110, b=0b0000_0000_0000_0000, sel=1).out == 0b0000_0000_0000_0000
    assert eval(Mux16, a=0b1010_1010_1010_1010, b=0b0101_0101_0101_0101, sel=0).out == 0b1010_1010_1010_1010
    assert eval(Mux16, a=0b1010_1010_1010_1010, b=0b0101_0101_0101_0101, sel=1).out == 0b0101_0101_0101_0101
...
def test_mux4way16():
    ...
    assert eval(Mux4Way16, a=11111, b=22222, c=33333, d=44444, sel=0b10).out == 33333
    assert eval(Mux4Way16, a=11111, b=22222, c=33333, d=44444, sel=0b11).out == 44444
...
def test_mux8way16():
    ...
    assert eval(Mux8Way16, a=11111, b=22222, c=33333, d=44444, e=55555, f=12345, g=23456, h=34567, sel=0b010).out == 33333
    assert eval(Mux8Way16, a=11111, b=22222, c=33333, d=44444, e=55555, f=12345, g=23456, h=34567, sel=0b011).out == 44444
    assert eval(Mux8Way16, a=11111, b=22222, c=33333, d=44444, e=55555, f=12345, g=23456, h=34567, sel=0b100).out == 55555
    assert eval(Mux8Way16, a=11111, b=22222, c=33333, d=44444, e=55555, f=12345, g=23456, h=34567, sel=0b101).out == 12345
    assert eval(Mux8Way16, a=11111, b=22222, c=33333, d=44444, e=55555, f=12345, g=23456, h=34567, sel=0b110).out == 23456
    assert eval(Mux8Way16, a=11111, b=22222, c=33333, d=44444, e=55555, f=12345, g=23456, h=34567, sel=0b111).out == 34567
